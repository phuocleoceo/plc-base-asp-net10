...
public class IssueController(IIssueService issueService) : BaseController
{
    ...
    )
    {
        return HttpContext.Success(
            await issueService.GetIssuesForBoard(projectId, sprintId, issueParams)
        );
    }
    ...
    {
        if (await issueService.UpdateBoardIssue(projectId, issueId, updateBoardIssueDTO))
    ...
    )
    {
        ...
        if (await issueService.MoveIssueToBacklog(reqUser, projectId, moveIssueDTO))
            return HttpContext.Success(true);
        return HttpContext.Failure();
    }
    ...
    {
        return HttpContext.Success(await issueService.GetIssuesInBacklog(projectId, issueParams));
    }
    ...
    {
        if (await issueService.UpdateBacklogIssue(projectId, issueId, updateBacklogIssueDTO))
            return HttpContext.Success(true);
        return HttpContext.Failure();
    }
    ...
    )
    {
        ...
        if (await issueService.MoveIssueToSprint(reqUser, projectId, moveIssueDTO))
            return HttpContext.Success(true);
        return HttpContext.Failure();
    }
    ...
    {
        return HttpContext.Success(await issueService.GetIssueById(projectId, issueId));
    }
    ...
    )
    {
        ...
        if (await issueService.CreateIssue(reqUser, projectId, createIssueDTO))
            return HttpContext.Success(true);
        return HttpContext.Failure();
    }
    ...
    )
    {
        ...
        if (await issueService.UpdateIssue(reqUser, projectId, issueId, updateIssueDTO))
            return HttpContext.Success(true);
        return HttpContext.Failure();
    }
    ...
    public async Task<SuccessResponse<bool>> DeleteIssue(int projectId, int issueId)
    {
        ...
        if (await issueService.DeleteIssue(reqUser, projectId, issueId))
            return HttpContext.Success(true);
        return HttpContext.Failure();
    }
}
